...
//
//	mockgen -source=domain/user/user_repository.go -destination=domain/user/user_mock_repository.go -package user
//
...
func (mr *MockUserRepositoryMockRecorder) FindUser(ctx, UserID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
